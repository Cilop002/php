            ...
            <div class="modal-dialog">
              <div class="modal-content">
                  ...
                  <div class="modal-footer m">
                    <input type="text" class="btn btn-primary" value="Aceptar" name="aceptDes">
                    <input type="text" class="btn btn-default" value="Cancelar" name="cancelDes" data-dismiss="modal">
                  </div>
              </div>
            </div>
          </div>
          ...
          <div class="modal fade" id="modelIngreso">
            <div class="modal-dialog">
              <div class="modal-content m">
                  ...
                  <div class="modal-footer m">
                    <input type="text" class="btn btn-primary" value="Aceptar" name="aceptDes1">
                    <input type="text" class="btn btn-default" value="Cancelar" name="cancelDes1" data-dismiss="modal">
                  </div>
              </div>
            </div>
          </div>
